...
EXCEPT_ALL = sys.version_info >= (3, 11, 4)
MATCH_STMT = sys.version_info >= (3, 10)
PYSIDE_BUFFERS = INLINE_TYPEVARS = sys.version_info >= (3, 12)  # in prevision to incoming python 3.12
